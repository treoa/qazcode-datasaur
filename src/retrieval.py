...
class HybridRetriever:
    ...
    def rerank(
        ...
        from cleaning import extract_diagnostic_snippet

        pairs = []
        for p in candidate_protocols:
            doc_text = extract_diagnostic_snippet(p, max_chars=800)
    ...
    def retrieve(
        ...
        dense_top = self.dense_search(query_embedding, k=30)
        sparse_top = self.sparse_search(query, k=30)
